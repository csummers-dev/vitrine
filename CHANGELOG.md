...
- **Removed three dead components** — `ProgressBar.vue`, `settings/Themes.vue`, and `files/ExtendedImage.vue` were leftovers replaced during the rebuild and imported nowhere; dropped them for hygiene (no behavior change)
